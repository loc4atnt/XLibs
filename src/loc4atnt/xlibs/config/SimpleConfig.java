...
public class SimpleConfig {
    ...
    public SimpleConfig(InputStream configStream, File configFile, int comments, JavaPlugin plugin) {
        ...
        try {
			this.config = YamlConfiguration.loadConfiguration(SimpleConfigManager.stream2file(configStream));
		} catch (IOException e) {
    ...
    public Set<String> loadListKey(String path) {
    ...
    public void reloadConfig() {
        try {
			this.config = YamlConfiguration.loadConfiguration(SimpleConfigManager.stream2file(manager.getConfigContent(file)));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
