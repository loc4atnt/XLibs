...
public class SimpleConfigManager {
    ...
    */
    ...
    public SimpleConfig getNewConfig(File pluginFolder, String filePath) {
    	
    	File file = this.getConfigFile(pluginFolder, filePath);
    	 
        if(!file.exists()) {
            this.prepareFile(pluginFolder, filePath);
        }
        
    	SimpleConfig config = new SimpleConfig(this.getConfigContent(pluginFolder, filePath), file, this.getCommentsNum(file), plugin);
        return config;
    }
    ...
    */
    public File getConfigFile(File pluginFolder, String file) {
        ...
        if(file.contains("/")) {
            ...
            if(file.startsWith("/")) {
                configFile = new File(pluginFolder + file.replace("/", File.separator));
            } else {
                configFile = new File(pluginFolder + File.separator + file.replace("/", File.separator));
            }
 
        } else {
            configFile = new File(pluginFolder, file);
        }
    ...
    public File getConfigFile(String file) {
        return getConfigFile(plugin.getDataFolder(), file);
    }
    ...
    */
	public void prepareFile(File pluginFolder, String filePath, String resource) {
    ...
    */
    public void prepareFile(String filePath) {
        this.prepareFile(plugin.getDataFolder(), filePath, null);
    }
    
    public void prepareFile(File pluginFolder, String filePath) {
    	this.prepareFile(pluginFolder, filePath, null);
    }
    ...
    */
	...
	public InputStream getConfigContent(File pluginFolder, String filePath) {
        return this.getConfigContent(this.getConfigFile(pluginFolder, filePath));
    }
