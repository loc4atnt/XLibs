...
public interface InventoryContents {
    ...
    InventoryContents editItem(int row, int column, ItemStack item);
    ...
    class Impl implements InventoryContents {
        ...
        @Override
        public InventoryContents editItem(int row, int column, ItemStack itemStack) {
            if(row >= contents.length)
                return this;
            if(column >= contents[row].length)
                return this;
            ...
            if(clickableItem!=null)
            	clickableItem.setItem(itemStack);
            
            update(row, column, itemStack != null ? itemStack : null);
            return this;
        }
